...
contract REVLoans is ERC721, ERC2771Context, IREVLoans, ReentrancyGuard {
    ...
    function revnetIdOfLoanWithId(uint256 loanId) public pure override returns (uint256) {
        ...
        returns (uint256 refinancedLoanId, uint256 newLoanId, REVLoan memory, REVLoan memory newLoan)
    {
        ...
        (newLoanId, newLoan) = borrowFrom({
            revnetId: revnetIdOfLoanWithId(refinancedLoanId),
            source: source,
            amount: amount,
        ...
        returns (uint256, REVLoan memory)
    {
        ...
        uint256 revnetId = revnetIdOfLoanWithId(loanId);
